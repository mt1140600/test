...
import ReturnsReplacmentsRow from './ReturnsReplacementsRow';
...
class ReturnsReplacments extends Component{
  ...
  constructor(){
    ...
    this.orders = [{returnDate:"28/11/2016", orderDate:"21/11/2016", productDetails:"Micromax Q24112 fnrelnf egrn", qty: "5", type: "Replacement", reasonForReturn: "Other: Size not as expected", currentStatus:"Pickup Initiated for customer"}];
  }
